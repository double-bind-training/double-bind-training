...
def main():
    ...
    wandb.init(project="masakhane-sentiment-test-run", entity="double-bind-sentiment", tags=args.tags.split(','), config = {
    ...
    model.add_classification_head("sentment_head", num_labels=len(labels))
    print(model)
